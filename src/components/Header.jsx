        ...
        <header className="w-full bg-gray-800 py-3 fixed top-0 right-0 z-10">
            <div className="w-full justify-between px-5 mx-auto lg:max-w-7xl lg:items-center lg:flex">
                ...
                <div>
                    ...
                    >
                        <ul className="h-screen lg:h-auto text-white text-[22px] lg:text-base font-medium space-y-12 flex items-center flex-col lg:flex-row lg:space-x-4 lg:space-y-0">
                            <li>
